...
class IncomeManager {
    ...
    setupEventListeners() {
        ...
        document.getElementById('income-taxable')?.addEventListener('change', (e) => {
    ...
    updateSummary() {
        ...
        // Update change color
        const changeElement = document.getElementById('income-change');
        changeElement.className = incomeChange >= 0 ? 'card-change positive' : 'card-change negative';
    }
    ...
    resetIncomeForm() {
        ...
        document.getElementById('tax-options').style.display = 'block';
    }
